...
|---|---|---|
| A: skill01–20 = skill levels/ranks | **`PROBABLE`** | 330/362 records change; power rises then plateaus; textually identical except Reload (ID 322), whose percentage description changes by variant; 20-step progression |
